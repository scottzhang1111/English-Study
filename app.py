...
def _grammar_lesson_payload(row, progress=None, quiz_count=0, correct_quiz_count=0):
    ...
    return {
       ...
       """  'jpExplanation': row['jp_explanation'], """
        ...
        'is_active': int(_row_value(row, 'is_active') or 0),
