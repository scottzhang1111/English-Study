              ...
              >
                <div className="flex items-center gap-4 max-md:gap-3">
                  ...
                  <div className="min-w-0 max-md:flex-1">
                    ...
                    <p className="mt-1 text-sm font-bold text-[#6f7da8] max-md:truncate max-md:text-xs">目標: {getTargetLevelLabel(child.targetLevel || child.target_level || child.learningGoal || child.learning_goal || child.grade)}</p>
